-- +goose Up
ALTER TABLE account_channel_memberships ADD COLUMN join_not_before TEXT;
...
SELECT account_id,catalog,channel_id,is_member,status,last_check_at,request_submitted_at,joined_at,last_error
