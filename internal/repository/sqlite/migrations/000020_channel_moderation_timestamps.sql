-- +goose Up
ALTER TABLE account_channel_memberships ADD COLUMN request_submitted_at TEXT;
ALTER TABLE account_channel_memberships ADD COLUMN joined_at TEXT;

UPDATE account_channel_memberships
SET request_submitted_at = last_check_at
WHERE status = 'pending_approval' AND last_check_at IS NOT NULL;
